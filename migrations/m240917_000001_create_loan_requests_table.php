...
class m240917_000001_create_loan_requests_table extends Migration
{
    ...
    {
        // Check if table already exists (created by init.sql)
        if ($this->db->schema->getTableSchema('loan_requests') === null) {
            ...
            echo "Table 'loan_requests' already exists, skipping creation.\n";
        }
    }
